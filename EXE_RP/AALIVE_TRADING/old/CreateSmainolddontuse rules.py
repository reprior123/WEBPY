...
##                        matchline = 'Signal.' + sym + ' ' + sind  + ' ' +  sdur  + ' ' +   rstring  +' ' + flag +' ' + str(sigprice)
                        formatl = ' %5s %7.2f %9s %9s %5s %s SIGNAL'
                        matchline = (formatl % (flag,float(sigprice),sind,sdur,sym,rsignbase))
                        print matchline
                        print sval, hitrigger,lotrigger
                        indns = ['ROC','mcross']
                        for indn in indns:
                            symn = 'ES'
                            durn='5mins'
##                            rpInd.ShowLastBarofInd(symn,durn,indn)
