...
files =  glob.glob(EXE+ 'IbPy-master/' + today + '*ES.4 D5*.csv')
print files                  
...
for inputfile in files:
    print inputfile
    ticklines = rpu_rp.CsvToLines('20150526.ticksnaps.csv')
##    for l in ticklines:
##        print l
    newbars =   rpInd.create_bars_from_snapshots(ticklines,5000,300,'fullbar')
    for b in newbars:
        print b
    rpu_rp.WriteArrayToCsvfile('20150526.ES.recent4 D5 mins.csv',newbars)
