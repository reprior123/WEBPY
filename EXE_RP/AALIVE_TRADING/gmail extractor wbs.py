...
##searchterm = '\"Swing Trade Alert\"'
fullargument = '(HEADER Subject ' + searchterm + ')'
print fullargument
##result, data = mail.uid('search', None, "ALL") # search and return uids instead
result, searchresultuidliststring = mail.uid('search', None, '(HEADER Subject "Fwd: William Blount observations")')
##result, searchresultuidliststring = mail.uid('search', None, fullargument)
print searchresultuidliststring
...
##    for l in rpu_rp.TxtToLines(bla):
##        if 'Bought' in str(l):
##            pass
##            print l
