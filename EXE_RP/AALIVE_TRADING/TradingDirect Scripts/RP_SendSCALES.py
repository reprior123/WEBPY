...
######                create_contract(sym,strike,expiry)
            ...
            bracketorder = ibutiles.create_bracket_order('LMT', tsizeprof1,treverseside,profprice,tranflag,profprice,profprice,'profittxt', parent_order_id)
            bracketorder2 = ibutiles.create_bracket_order('LMT', tsizeprof2,treverseside,profprice2,tranflag,profprice2,profprice2,'profittxt', parent_order_id)
##            bracketorderSTP = ibutiles.create_bracket_order('STP', tsize,treverseside,stopprice,tranflag,stopprice,stopprice,'stoptxt', parent_order_id)
            ...
            if online == 'online':
                ...
                tws_conn.placeOrder(parent_order_id+2, symcontract, bracketorder2)
                sleep(1)
