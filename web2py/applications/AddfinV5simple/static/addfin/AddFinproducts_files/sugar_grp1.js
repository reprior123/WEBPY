...
try{tabs[i].get("labelEl").style.color="";}catch(e){}}}}
...
sugarListView.prototype.check_all=function(form,field,value,pageTotal){count=0;$(document.MassUpdate.massall).each(function(){$(this).prop('checked',value).trigger('change');});if(document.MassUpdate.select_entire_list&&document.MassUpdate.select_entire_list.value==1)
...
count++;form.elements[i].checked=value;$(form.elements[i]).trigger('change');if(!value){sugarListView.prototype.updateUid(form.elements[i],form);}}}
if(pageTotal>=0)
